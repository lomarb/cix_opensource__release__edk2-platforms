...
##################################################
  ...
  DEFINE GPIO_POWER_BUTTON_ENABLE   = FALSE
...
# PlatformConfigParamsHookLib - RTC voltage drop detect + Get EC Board ID
  ...
  PinMuxTableLib|Platform/CIX/Sky1/MGP1WSB/Library/PinMuxTableLib/PinMuxTableLib.inf
  GpioTableLib|Platform/CIX/Sky1/MGP1WSB/Library/GpioTableLib/GpioTableLib.inf
  PlatformConfigParamsHookLib|Platform/CIX/Sky1/Library/PlatformConfigParamsHookLib/PlatformConfigParamsHookLib.inf
  ConfigParamsHookLib|Platform/CIX/Sky1/MGP1WSB/Library/ConfigParamsHookLib/ConfigParamsHookLib.inf
  PlatformEnvHookLib|Platform/CIX/Sky1/MGP1WSB/Library/PlatformEnvHookLib/PlatformEnvHookLib.inf
  RealTimeClockLib|Platform/CIX/Sky1/Library/Ra8900ceRealTimeClockLib/Ra8900ceRealTimeClockLib.inf

  PlatformBootHookLib|Platform/CIX/Sky1/MGP1WSB/Library/PlatformBootHookLib/PlatformBootHookLib.inf
  PlatformBootManagerLib|Platform/CIX/Sky1/MGP1WSB/Library/PlatformBootManagerLib/PlatformBootManagerLib.inf
...
[LibraryClasses.common.DXE_RUNTIME_DRIVER]
  EfiResetSystemLib|Platform/CIX/Sky1/MGP1WSB/Library/ArmPsciResetSystemLib/ArmPsciResetSystemLib.inf
...
!if $(ACPI_ENABLE) == TRUE
  Platform/CIX/Sky1/MGP1WSB/ACPI/AcpiPlatfomTables/AcpiPlatfomTables.inf
  Platform/CIX/Sky1/MGP1WSB/ACPI/AcpiPlatformDxe/AcpiPlatformDxe.inf
!endif
!if $(SMBIOS_ENABLE) == TRUE
  Platform/CIX/Sky1/MGP1WSB/PlatformSmbios/PlatformSmbios.inf
!endif
  Platform/CIX/Sky1/MGP1WSB/Drivers/Logo/LogoDxe.inf
  Platform/CIX/Sky1/MGP1WSB/Drivers/PlatformSetupVariableInitDxe/PlatformSetupVariableInitDxe.inf
  Platform/CIX/Sky1/MGP1WSB/Drivers/SetupManagerDxe/SetupManagerDxe.inf
...
!if $(LINUX_ACPI_CONFIG_OVERRIDE) == TRUE
  ...
  GCC:*_*_*_ASLPP_FLAGS           = -I$(WORKSPACE)/Platform/CIX/Sky1/MGP1WSB/ACPI
!endif
...
!endif
  ...
  gCixTokenSpaceGuid.PcdPcieRootPort4PeResetPin|3
  ...
  gCixTokenSpaceGuid.PcdI2c3Runtime|FALSE          # For RTC runtime service
...
# ISP Camera Power
  ...
  gCixPlatformTokenSpaceGuid.PcdAcpiGpio4IoMask|0x00180000 # wifi/bt disable pin output

  gCixTokenSpaceGuid.PcdSocWatchdogTimer|0x01

  gCixTokenSpaceGuid.PcdGmac0Enable|FALSE
...
# Touch Panel
  gCixPlatformTokenSpaceGuid.PcdAcpiGpio2IoMask|0x000F0000 # tp_pwr_en, tp_en, tp_reset and tp_int

# CSI_DMA
  gCixTokenSpaceGuid.PcdAcpiCsiDmaEnable|FALSE

  # PD Dev
  gCixPlatformTokenSpaceGuid.PcdPdDevCount|4|UINT8|0x0000013C
  # Refer to TYPEC_MODE enum
  gCixPlatformTokenSpaceGuid.PcdTypecPortDefaultModes|{ 1, 1, 4, 1 }|VOID*|0x0000013D # 0: disconnect, 1: usb only, 3: usb+dp 4: dp only
  # Refer to TYPEC_ORIENTATION enum
  gCixPlatformTokenSpaceGuid.PcdTypecPortDefaultOrientations|{ 1, 1, 1, 1 }|VOID*|0x0000013E # 0: none, 1: normal, 2: reverse
  gCixPlatformTokenSpaceGuid.PcdPdDevAlertPins|{ 8, 8, 0xFF, 0xFF }|VOID*|0x0000013F
  gCixPlatformTokenSpaceGuid.PcdPdDevI2cBuses|{ 0x7, 0x7, 0xFF, 0xFF }|VOID*|0x00000140 # 0xFF: not actual pd device
  gCixPlatformTokenSpaceGuid.PcdPdDevI2cSlaveAddresses|{ 0x30, 0x31, 0xFF, 0xFF }|VOID*|0x00000141  # 0xFF: not actual pd device

  gCixPlatformTokenSpaceGuid.PcdPowerButtonGpioNum|16
