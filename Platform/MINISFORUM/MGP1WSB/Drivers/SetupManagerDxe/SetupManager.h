...
//
extern UINT8  SetupManagerVfrBin[];

#define SETUP_MANAGER_CALLBACK_DATA_SIGNATURE  SIGNATURE_32 ('S', 'M', 'C', 'B')
...
#define SETUP_MANAGER_CALLBACK_DATA_FROM_THIS(a) \
  CR (a, \
      SETUP_MANAGER_CALLBACK_DATA, \
      ConfigAccess, \
