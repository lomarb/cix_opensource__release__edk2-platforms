    ...
    .board_sensor1 = {
        .sensor_valid ={
            .fields = {
                ...
                .raw_data       = 1,    // 0:connect to EC   1:connect to soc i2c;
            }
        },
        .i2c_ctrl    = 3,               // valid ctrl are 0/1/2/3
        .i2c_addr    = 0x4d,
        .sensor_type = 0,
        .reg_addr    = 0,
    },
...
static pm_config_fan_t fan_config[MAX_FAN_NUM] = {
    [0] = {
        ...
        .rpm_table_items = {
            8,                   // table size of NORMAL,      i.e. the valid items number of fan_config[0].rpm_table[FAN_MODE_NORMAL]
        ...
        .fan_id = {
            .fields = {
                .valid = PM_CONFIG_VALID,
                .raw_data = 2, // which pwm&tach is used to control the fan, it should be correspond to hardware design. 0/1/2 are valid value.
            }
        },
        .sensor_id = {
            .fields = {
   ...
   [1] = {//PCIE
        ...
        .rpm_table_items = {
            2,                   // table size of NORMAL,      i.e. the valid items number of fan_config[0].rpm_table[FAN_MODE_NORMAL]
            4,                   // table size of PERFORMANCE, i.e. the valid items number of fan_config[0].rpm_table[FAN_MODE_PERFORMANCE]
            4,                   // table size of QUIET,       i.e. the valid items number of fan_config[0].rpm_table[FAN_MODE_QUIET]
        }, /* valid items number of NORMAL/PERF/QUIET respectively */
